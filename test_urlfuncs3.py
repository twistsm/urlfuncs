...
class TestUrlfuncs(unittest.TestCase):
    """ Test Cases for urlfuncs3.py library
    """

    def test_get_domain_zone(self):
        f = urlfuncs3.get_domain_zone
        ...
        self.assertEqual(f('http://привет.рф'), 'рф')
        self.assertEqual(f('http://test.museum/'), 'museum')

    def test_get_root_domain_zone(self):
        f = urlfuncs3.get_root_domain_zone
        self.assertEqual(f('google.ca'), 'ca')
        self.assertEqual(f('www.google.org'), 'org')
    ...
    def test_toggle_last_url_slash(self):
        f = urlfuncs3.toggle_last_url_slash
        # Test regular URLS
    ...
    def test_is_string_url(self):
        ...
        self.assertEqual(f('ftp://ru.ru'), True)
    ...
    def test_is_url_domain(self):
        ...
        self.assertEqual(f('http://привет.рф?t=5'), False)
    ...
    def test_clear_http_and_last_slash(self):
        f = urlfuncs3.clear_http_and_last_slash
    ...
    def test_is_url_or_domain_valid(self):
        f = urlfuncs3.is_url_or_domain_valid
    ...
    def test_decode_string(self):
        f = urlfuncs3.decode_string
        # Decode strings from any encoding in fast way
        self.assertEqual(f("hello"), "hello")
        self.assertEqual(f("привет"), "привет")
        self.assertEqual(f("test".encode('cp1251')), "test")
        self.assertEqual(f("кои8р".encode('koi8-r')), "кои8р")

    def test_parse_url_list(self):
        f = urlfuncs3.parse_url_list
    ...
    def test_parse_domain_list(self):
        f = urlfuncs3.parse_domain_list
        domains_text = ' http://test.com \n\n www.test2.com/test/?q=\r\n'
        domains_list = ['test.com', 'www.test2.com']
        self.assertEqual(f(domains_text), domains_list)
